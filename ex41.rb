...
def central_corridor()
  puts "The Gothons of Planet Percel #25 have invaded your ship and destroyed"
  ...
  if action == "shoot"
    ...
    puts "Lucky for you they made you Gothon insults in the academy."
    puts "You tell the one Gothon joke you know:"
    puts "asdhj asffgh fgn hjert dfg ret f dfgweruyka asdq ppoij mn jkn."
...
def the_bridge()
  ...
  puts "under your arm and supriise 5 Gothons who are trying to"
...
def escape_pod()
  ...
  puts "interference. You get to the chamber with the escape pods,"
...
ROOMS = {
  ...
  :laser_weapon_armoury => method(:laser_weapon_armoury),
